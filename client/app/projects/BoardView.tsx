            ...
            <div className="mb-3 flex w-full">
                ...
                <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-secondary">
                    <h3 className="flex items-center text lg font-semibold dark:text-white">
                        {status}{" "}
                        <span 
                            className="ml-2 inline-blcok rounded-full bg-gray-200 p-1 text-center text-sm leading-none dark:bg-dark-tertiary"
    ...
    return (
        ...
        >
            {task.attachments && task.attachments.length > 0 && (
                <Image
                    src={`https://kb-pm-s3-images.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
            ...
            <div className="p-4 md:p-6">
                    ...
                    <div className="flex flex-1 flex-wrap items-center gap-2">
                        ...
                        <div className="flex gap-2">
                            {taskTagsSplit.map((tag) => (
                                <div key={tag} className="rounded-full bg-blue-100 px-2 py-2 text-xs">
                                    {" "}
                                    {tag}
                                </div>
                            ))}
                ...
                <p className="text text-gray-600 dark:text-neutral-500">
                {task.description}
                </p>
                    ...
                    <div className="flex -space-x-[6px] overflow-hidden">
                        {task.assignee && (
                            <Image 
                                ...
                                src={`https://kb-pm-s3-images.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
                        ...
                        {task.author && (
                            <Image 
                                ...
                                src={`https://kb-pm-s3-images.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
