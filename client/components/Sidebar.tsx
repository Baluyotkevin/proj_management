    ...
    <div className={sidebarClassNames}>
        ...
        <div className="flex h-[100%] w-full flex-col justify-start">
            ...
            <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
                <Image src="https://kb-pm-s3-images.s3.us-east-1.amazonaws.com/logo.jpeg" alt="logo" width={40} height={40} />
                <div>
        ...
        <div className="z-10 mt-32 flex w-fuill flex-col items-center gap-4 bg-white px-8 py-4 dark:bg-black md:hidden">
              <div className="flex w-full items-center">
                <div className="align-center flex h-9 w-9 justify-center">
                    {!!currentUserDetails?.profilePictureUrl ? (
                        <Image
                            src={`https://kb-pm-s3-images.s3.us-east-1.amazonaws.com/${currentUserDetails?.profilePictureUrl}`}
                ...
                <span className="m-3 text-gray-800 dark:text-white">
    ...
    return (
        <Link href={href} className="w-full">
            <div className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:bg-black dark:hover:bg-gray-700 ${isActive ? "bg-gray-100 text-white dark:bg-gray-600" : ""} justify-start px-8 py-3`}>
                {isActive && (
                    <div className="absolute left-0 top-0 left=[100%] w-[5px] bg-blue-200" />
                )}
